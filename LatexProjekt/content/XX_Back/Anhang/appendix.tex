...
\begin{figure}[tbh]
    \centering
    \includegraphics[scale=0.7]{images/Evaluationsprotokoll_Zeichenfläche 1-01.png}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[scale=0.7]{images/Evaluationsprotokoll_Zeichenfläche 1-02.png}
